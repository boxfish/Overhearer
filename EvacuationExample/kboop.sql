...
BEGIN TRANSACTION;
CREATE TABLE 'Questions' ('Type' INTEGER, 'QuestionID' INTEGER, 'Sentence' TEXT, 'Token' TEXT);
INSERT INTO "Questions" VALUES(2,1,'I have the following data for . Which would you like to see?','6,Phrase,7,RefIDs');
CREATE TABLE 'Actions_back' ('Action_no' INTEGER, 'ActionName' TEXT, 'ActType' TEXT, 'Generates' TEXT, 'Complexity' TEXT, 'Recipe' TEXT, 'Context_No' INTEGER);
...
CREATE TABLE 'Contexts' ('ContextId' INTEGER, 'Name' TEXT, 'Host' TEXT, 'AppServer' TEXT, 'ServiceName' TEXT, 'Configuration' TEXT);
...
CREATE TABLE 'reference_layer_view' ('RefID' INTEGER, 'RefType' TEXT, 'LayerId' INTEGER, 'Filter' TEXT, 'SearchField' TEXT, 'Description' TEXT, 'LayerName' TEXT, 'LayerType' TEXT, 'Category' TEXT, 'Symbology' TEXT, 'IDField' TEXT, 'LabelField' TEXT, 'Workspace' TEXT, 'Context-No' INTEGER);
...
CREATE TABLE 'LayerAttributes' ('LayerID' INTEGER, 'SelectedAttributes' TEXT);
INSERT INTO "LayerAttributes" VALUES(5,'NAME');
INSERT INTO "LayerAttributes" VALUES(11,'NAME');
CREATE TABLE 'Connection' ('Name' TEXT, 'IP' TEXT);
INSERT INTO "Connection" VALUES('Radiation Measurement Team','10.20.30.40');
CREATE TABLE 'LayerInfo' ('LayerID' INTEGER, 'LayerName' TEXT, 'LayerType' TEXT, 'Category' TEXT, 'Symbology' TEXT, 'IDField' TEXT, 'LabelField' TEXT, 'Workspace' TEXT, 'Context-No' INTEGER);
...
CREATE TABLE 'DisplayGroups' ('Context' INTEGER, 'Layer' INTEGER, 'Display' TEXT);
INSERT INTO "DisplayGroups" VALUES(1,22,'3,4,6');
CREATE TABLE 'Actions' ('Action_no' INTEGER, 'ActionName' TEXT, 'ActType' TEXT, 'Generates' TEXT, 'Complexity' TEXT, 'Recipe' TEXT, 'Context_No' INTEGER);
...
CREATE TABLE 'Phrases_back' ('PID' INTEGER, 'Phrase' TEXT, 'Type' TEXT, 'ActionName' TEXT, 'Alias' TEXT, 'RefID' TEXT, 'ContextId' INTEGER);
...
CREATE TABLE 'referenceInfo' ('RefID' INTEGER, 'RefType' TEXT, 'LayerId' INTEGER, 'Filter' TEXT, 'SearchField' TEXT, 'SearchPhrase' TEXT, 'ScaleFactor' INTEGER);
INSERT INTO "referenceInfo" VALUES(1001,'Feature',5,NULL,'CITY_NAME','Salt Lake City',8);
CREATE TABLE 'Phrases' ('PID' INTEGER, 'Phrase' TEXT, 'Type' TEXT, 'ActionName' TEXT, 'Alias' TEXT, 'RefID' TEXT, 'ContextId' INTEGER);
...
CREATE TABLE 'Symbology' ('ParameterName' TEXT, 'ParameterValue' TEXT, 'FillColor' TEXT, 'FillStyle' TEXT, 'FillInterval' TEXT, 'BoundaryStyle' TEXT);
